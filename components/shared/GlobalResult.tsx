...
const GlobalResult = () => {
  ...
  useEffect(() => {
    const fetchResult = async () => {
      ...
      try {
        // EVERYTHINK EVERYWHERE All AT ONCE .......> GLOBAL SEARCH!
  ...
  return (
    <div className="absolute top-full z-10 mt-3 w-full bg-light-800 py-5 shawdow-sm dark:bg-dark-400 rounded-xl">
